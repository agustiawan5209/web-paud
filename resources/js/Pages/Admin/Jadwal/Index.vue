...
function deleteItem() {
    DeleteForm.delete(route('Jadwal.destroy'), {
        preserveState: true,
        preserveScroll: true,
        onFinish: () => {
                                        ...
                                        <dropdownTable align="top" width="48" :key="index">
                                            ...
                                            <template #content>
                                                ...
                                                <DropdownLink v-if="crud.edit"
                                                    :href="route('Jadwal.edit', { slug: item.id })"
                                                ...
                                                <DropdownLink v-if="crud.show"
                                                    :href="route('Jadwal.show', { slug: item.id })"
                                                    class="flex justify-start gap-3 text-gray-700">
                                                ...
                                                <DropdownLink v-if="crud.reset_password"
                                                    :href="route('Jadwal.reset.password', { slug: item.user.id })"
                                                    class="flex justify-start gap-3 text-gray-700">
                                                    <font-awesome-icon class="text-blue-500 hover:text-blue-700"
                                                        :icon="['fas', 'key']" />
                                                    Reset Password

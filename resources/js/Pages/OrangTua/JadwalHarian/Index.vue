...
watch(search, (value) => {
    Form.search = value
    Form.get(route('Org.JadwalHarian.index'), {
        preserveScroll: true,
        preserveState: true,
    })
})
...
function deleteItem() {
    DeleteForm.delete(route('Org.JadwalHarian.destroy'), {
        preserveState: true,
        preserveScroll: true,
        onFinish: () => {
                    ...
                    <table class="w-full whitespace-no-wrap">
                        <thead>
                            <tr
                                ...
                                <!-- <th class="px-4 py-3">Nama JadwalHarian</th> -->
                                        ...
                                        <dropdownTable align="top" width="48" :key="index">
                                            ...
                                            <template #content>
                                                ...
                                                <DropdownLink v-if="crud.show"
                                                    :href="route('Org.JadwalHarian.show', { slug: item.id })"

...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2>Buku Penghubung Siswa</h2>
        </template>

        <div class="py-4 relative box-content">
            <CardTable @update:search="search = $event" @update:order="order" :slug="null" path="Org.Nilai" :TableData="data" :tableColums="table_colums" :crud="crud" />
        </div>
    </AuthenticatedLayout>
</template>

...
const Form = useForm({
    slug: props.absen.id,
    kelas_id: props.absen.kelas_id,
    tanggal: props.absen.tanggal,
    siswa: [],
})
...
if (props.absen) {
    ...
    console.log(props.absen)
    for (let index = 0; index < props.absen.dataabsensi.length; index++) {
        const element = props.absen.dataabsensi[index];
        AbsensSiswa.value.push({
            siswa_id: element.siswa.id,
            nama: element.siswa.nama,
            absen: element.absen,
            ...
            <section class="p-6 bg-gray-100 text-gray-900">
                <form @submit.prevent="submit()" novalidate="" action=""
                    ...
                    <div class="space-y-2 col-span-full lg:col-span-1">
                        <p class="font-medium">Edit Absensi Kelas (Tahun Ajaran ={{ absen.tanggal }} || Kelas= {{ absen.kelas.kode }})</p>
                    </div>
